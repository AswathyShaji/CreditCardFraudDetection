<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="CompanyList-Pending(profile).aspx.cs" Inherits="Admin_CompanyList_Pending_profile_" %>
            ...
            <td>
                <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="47px" Width="255px" OnItemCommand="DetailsView1_ItemCommand">
                    ...
                    <Fields>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%# Eval("comp_id") %>' CommandName="ac">Accept</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Fields>
