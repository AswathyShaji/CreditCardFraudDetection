<%@ Page Title="" Language="C#" MasterPageFile="~/admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="CompanyList-Pending.aspx.cs" Inherits="Admin_CompanyList_Pending" %>
            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" EmptyDataText="No Record Found..." OnRowCommand="GridView1_RowCommand" PageSize="5">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("comp_id") %>' CommandName="vm">View More</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
