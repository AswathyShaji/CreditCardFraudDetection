...
public partial class bank_Default : System.Web.UI.Page
{
    ...
    protected void txtcardnumber_TextChanged(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblbalance.Text = dt.Rows[0]["a_amount"].ToString();  
    ...
    protected void btnok_Click(object sender, EventArgs e)
    {
        ...
        string ins = "insert into tbl_withdraw(a_cardnumber,witdraw_date,withdraw_amount) values('" + txtcardnumber.Text + "','" + DateTime.Now.ToShortDateString() + "','" + txtamount.Text + "')";
