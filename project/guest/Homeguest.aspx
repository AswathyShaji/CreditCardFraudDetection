<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Homeguest.aspx.cs" Inherits="guest_Homeguest" %>
  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_left">
      <ul>
        ...
        <li style="font-family: 'times New Roman', Times, serif; text-transform: lowercase; font-size: large;"><i class="fa fa-envelope-o"></i> info@CreditCardFraudDetection.com</li>
      </ul>
    </div>
    <div class="fl_right">
      <ul>
        <li><a href="Homeguest.aspx"><i class="fa fa-lg fa-home"></i></a></li>
        <li><a href="login.aspx" style="font-family: 'times New Roman', Times, serif; text-transform: capitalize; font-size: large;">Login</a></li>
        <li><a href="contact.aspx" style="font-family: 'Times New Roman', Times, serif; text-transform: capitalize; font-size: large;">Contact</a></li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
  </div>
...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.html">Credit Card Fraud Detection</a></h1>
  ...
  <nav id="mainav" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <ul class="clear">
      <%--<li class="active"><a href="Homeguest.aspx">Home</a></li>--%>
        <li><a href="Homeguest.aspx" style="font-family: 'times New Roman', Times, serif; color: #FFFFFF">Home</a></li>
      <li><a class="drop" href="#" style="font-family: 'times New Roman', Times, serif">Registration</a>
        <ul>
          <li><a href="newuser.aspx">User</a></li>
     ...
     <%-- <li><a class="drop" href="#">Dropdown</a>
      ...
      <li><a href="login.aspx" style="font-family: 'times New Roman', Times, serif">Login</a></li>
      <li><a href="About.aspx" style="font-family: 'times New Roman', Times, serif">About us</a></li>
      <li><a href="contact.aspx" style="font-family: 'times New Roman', Times, serif">Contact</a></li>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/49792-card-shopping-bags.png');">
  <div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
      <p>CDFD</p>
      <h3 class="heading" style="text-transform: capitalize; font-family: 'times New Roman', Times, serif; font-size: x-large;">Credit Card Fraud Detection</h3>
      <p>Hidden Markov Model will be helpful to find out the fraudulent transaction by using spending profiles of user</p>
      <footer>
    ...
    <div class="one_third first">
      ...
      <ul class="nospace btmspace-30 linklist contact">
        <li><i class="fa fa-map-marker"></i>
          <address>
         CreditCardFraudDetection &amp; +00 (123) 456 7890, TDPA, 685698
          </address>
        </li>
        <li><i class="fa fa-phone"></i> +00 (123) 456 7890</li>
        <li><i class="fa fa-fax"></i> +00 (123) 456 7890</li>
        <li><i class="fa fa-envelope-o"></i> info@creditcardfrauddetection.com</li>
      </ul>
    </div>
    <div class="one_third">
      <h6 class="heading">Sign in </h6>
      <p class="nospace btmspace-30">sign in to post your feedback/comments.</p>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <p class="fl_left">Copyright &copy; 2016 - All Rights Reserved - <a href="#">CreditCardFraudDetection</a></p>
