<%@ Page Title="" Language="C#" MasterPageFile="~/User/PurchasePhoto/Purchasemaster.master" AutoEventWireup="true" CodeFile="PurchaseReport.aspx.cs" Inherits="User_PurchasePhoto_PurchaseReport" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal">
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Invoice Number">
                            <ItemTemplate>
                                <a href="Details.aspx?idno=<%#Eval("ph_id")%>"><%#Eval("ph_billno") %></a>
                            </ItemTemplate>
                        </asp:TemplateField>
